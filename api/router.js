...
var appRouter = function(app) {
	...
	app.get("/creditoPessoal/proposta", function(req, res) {
		var oResult = fetch("https://sb-api.portocred.com.br/credito-pessoal-demo/v1/propostas", {
	    	method: 'POST',
		    headers: {
